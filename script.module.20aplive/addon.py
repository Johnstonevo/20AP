...
@plugin.route('/')
def root():
    categories = {"01": "[COLOR purple][B]UK & USA[COLOR white] Channels[/B][/COLOR]",
                  "02": "[COLOR purple][B]M[COLOR white]OVIES[/B][/COLOR]",
                  "03": "[COLOR purple][B]M[COLOR white]USIC[/B][/COLOR]",
                  "04": "[COLOR purple][B]N[COLOR white]EWS[/B][/COLOR]",
                  "05": "[COLOR purple][B]S[COLOR white]PORTS[/B][/COLOR]",
                  "06": "[COLOR purple][B]D[COLOR white]OCUMENTARY[/B][/COLOR]",
                  "07": "[COLOR purple][B]K[COLOR white]IDS[/B][/COLOR]",}
    list_items = []
