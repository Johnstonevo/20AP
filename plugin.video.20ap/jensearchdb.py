...
def main():
    main_url = "https://raw.githubusercontent.com/Johnstonevo/20ap/master/base/20AP/base/base.xml"  #your main.xml url goes here
    sections = [
        {'name': '20ap', # can change jen to whatever you want.  This wil name the output xml jen.xml
         'url': "https://raw.githubusercontent.com/Johnstonevo/20ap/master/base/20AP/base/base.xml", # your section xml goes here
         'poster': '20ap'}, # can change Jen to whatever you want. This will be displayed as the poster name on jen.xml and
                           # also in the actual search in your addon in kodi eg Jen - The Avengers
    ]

    os.remove("/home/iain/Documents/search.db")  # add the directory to where this file is stored
    dbcon = database.connect("/home/iain/Documents/search.db") # add the directory to where this file is stored
    dbcur = dbcon.cursor()
    dbcur.execute(
    ...
    for section in sections:
        ...
        file = open("/home/iain/Documents/output/" + section['name'] + ".xml", "wb")
        xml = "<poster>%s</poster>\n" \
              "<cache>43200</cache>\n\n" % section['poster'] + xml
